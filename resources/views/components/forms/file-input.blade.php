...
@section('js')
 ...
 <script type="text/javascript">
       ...
       var CustomFile = (function(inputName, idAttr, uploadableFileCount, fileType) {
          ...
          var fileTypeIcon = '<i class="fa fa-file-image-o" aria-hidden="true"></i>';
          if ( fileType === 'pdf') {
            fileTypeIcon = '<i class="fa fa-file-pdf-o" aria-hidden="true"></i>';
          } else if( fileType === 'video') {
            fileTypeIcon = '<i class="fa fa-file-video-o" aria-hidden="true"></i>';
          }
          ...
          function fileTemplate(inputName, index, customFileWrapperCount) {
            ...
            return '<div style="background: ;height: 62px;margin-bottom: 10px;display: block;" class="custom-file-wrapper-'+idAttr+'" wrap-id="'+idAttr+index+'">'+
                    '<div style="width: calc( 100% - 2px );height: 35px;background: #ced4da;padding:1px;border-top-right-radius: 2px;border-bottom-right-radius: 2px;border-top-left-radius: 2px;border-bottom-left-radius: 2px;">'+
                        '<div style="width: 32px;height: 33px;border-right:1px #ced4da solid;background-color: #f5f5f5;float: left;border-top-left-radius: 2px;border-bottom-left-radius: 2px;padding-top: 4px;">'+fileTypeIcon+'</div>'+
         ...
         function displayFile() {
            ...
            if( customFileWrapperCount < uploadableFileCount ) {
                ...
                // alert("Only " + uploadableFileCount + " File(s) are allowed.");
            }             
         }
         displayFile();
         return;
